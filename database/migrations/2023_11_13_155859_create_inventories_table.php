...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('inventories', function (Blueprint $table) {
            ...
            $table->float('amount', 10, 2)->comment('Cantidad de producto que hay');
			$table->timestamp('mute_date', 0)->nullable()->comment('Si es null o si han pasado 7 días del muteo sí se enviará en el reporte de críticos');
