...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('decreases', function (Blueprint $table) {
            $table->increments('id');
            $table->string('reason', 255)->comment('Razón por la cual se echó a perder el producto');
            $table->string('url', 255)->comment('Foto del producto');
            $table->timestamp('decrease_date', 0)->comment('Fecha en la que se echó a perder el producto');
