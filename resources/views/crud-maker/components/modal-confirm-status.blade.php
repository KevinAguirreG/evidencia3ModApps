<div class="modal" id="confirmrowModal" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		{{ Form::open(['method' => 'get', 'name' => 'confirmrowForm', 'id' => 'confirmrowForm']) }}
		<div class="modal-content">
			...
			@if($footer ?? true)
				<div class="modal-footer">
					...
					{{ Form::button(__("Aceptar"), ["class" => "btn btn-primary button-delete"]) }}
				</div>
			@endif
		</div>
		{{ Form::close() }}
