...
/**
 * Source: https://github.com/lecano/php-numero-a-letras
 * Copied to modify the output format
 */
...
class NumberToText
{
    ...
    public function toInvoice($number, $decimals = 2, $currency = '')
    {
        ...
        $result = $this->glue($splitNumber, $currency);
     ...
     * @return string
     */
    private function glue($splitNumber, $currency)
    {
        return trim(implode(' ' . mb_strtoupper($currency, 'UTF-8') . ' ', array_filter($splitNumber)));
    }
